...
MIDDLEWARE = [
    ...
    'marketplace.middleware.customer_auth.CustomerAuthenticationMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'marketplace.context_processors.maintenance',
            ],
        },
    },
]
...
FAST2SMS_WHATSAPP_PHONE_NUMBER_ID = config(
    "FAST2SMS_WHATSAPP_PHONE_NUMBER_ID"
)
FAST2SMS_WHATSAPP_API_VERSION = config(
    "FAST2SMS_WHATSAPP_API_VERSION",
    default="v26.0"
)
FAST2SMS_WHATSAPP_OTP_TEMPLATE = config(
    "FAST2SMS_WHATSAPP_OTP_TEMPLATE",
    default="loka_login_otp"
)
FAST2SMS_WHATSAPP_OTP_LANGUAGE = config(
